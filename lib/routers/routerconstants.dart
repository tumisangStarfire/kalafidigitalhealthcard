...
const String CreatePasswordRoute = 'createpassword';
...
const String CreateUserInjuryRoute= 'createuserinjury';

const String ListUserIllnessRoute ='listuserillness';

const String CreateUserIllnessRoute = 'createuserillness';

const String MedicalConditionsRoute = 'medicalconditions';

const String CreateMedicalConditionRoute = 'createmedicalconditions';

const String CreateCurrentMedicationRoute ='createcurrrentmedication';

const String ListCurrentMedicationRoute = 'listcurrentmedication';
